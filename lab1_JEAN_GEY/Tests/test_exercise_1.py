...
class Test_Exercise_1(unittest.TestCase):
    ...
    def test_invariant_distribution_True(self):
        self.assertTrue(self.workflow.check_invariant_distribution(binom(self.workflow.K, 0.5)))
    
    def test_invariant_distribution_False(self):
        self.assertFalse(self.workflow.check_invariant_distribution(binom(self.workflow.K, 0.2)))
